...
async function getSession() {
    const res = await fetch('https://julesp.promo-23.codeur.online/meteo/weather/session', {method: "POST"});
        ...
        if (document.readyState === "complete") {
            ...
            if (navigator.geolocation) { /*demander l'autorisation d'obtenir la géolocalisation*/
                navigator.geolocation.getCurrentPosition(function (position) {
                    ...
                    fetch("https://julesp.promo-23.codeur.online/meteo/weather/get", {method: "POST", body: data})
                    .then((retourReponse) => {
...
function displayData(retourReponse) {
    ...
    weatherImg.src = "https://julesp.promo-23.codeur.online/meteo/Assets/img/weather-icons/" + retourReponse.currently.icon + ".svg";
...
function displayHourly() {
    ...
    weatherImg.src = "https://julesp.promo-23.codeur.online/meteo/Assets/img/weather-icons/" + result.hourly.data[setTime.value].icon + ".svg";
